...
EMAILS_ESCALERA = [
    ...
    "cristiane.aguilar@caiuas.com.br","nathalli.pereira@caiuas.com.br","kathie.sampaio@caiuas.com.br"
]
...
def render():
    ...
    df_export = df_chatwoot_excel.drop(columns=['link_crm', 'link_chat', 'status'], errors='ignore').copy()
